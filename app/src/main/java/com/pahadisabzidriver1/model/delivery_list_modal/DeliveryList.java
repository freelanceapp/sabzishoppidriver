...
public class DeliveryList implements Parcelable {
    ...
    @SerializedName("delivery_schedule_type")
    @Expose
    ...
    protected DeliveryList(Parcel in) {
        ...
        this.deliveryScheduleType = ((String) in.readValue((String.class.getClassLoader())));
    ...
    public String getDeliveryScheduleType() {
        return deliveryScheduleType;
    }

    public void setDeliveryScheduleType(String deliveryScheduleType) {
        this.deliveryScheduleType = deliveryScheduleType;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(deliveryScheduleType);
