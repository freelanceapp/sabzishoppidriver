...
public class DeliveryListAdapter extends RecyclerView.Adapter<DeliveryListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.txtTime.setText(itemsDataList.get(position).getDeliveryScheduleType());
        if (itemsDataList.get(position).getPaymentType().equals("0"))
        {
            holder.txtPaymentType.setText("COD");
        }else {
            holder.txtPaymentType.setText("Payment");
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView txtOrderNumber, txtHouseNo, txtDistance, txtLandmark, txtAddress,
                txtPaymentType, txtAmount, txtTime;
