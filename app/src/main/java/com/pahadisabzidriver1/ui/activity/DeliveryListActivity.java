...
import com.pahadisabzidriver1.adapter.DeliveryListAdapter;
import com.pahadisabzidriver1.constant.Constant;
import com.pahadisabzidriver1.model.User;
import com.pahadisabzidriver1.model.delivery_list_modal.DeliveryList;
...
import com.pahadisabzidriver1.ui.map_activity.MapsActivity;
...
import com.pahadisabzidriver1.utils.GpsTracker;
...
public class DeliveryListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        Log.e("Id "," : "+User.getUser().getDriver().getDriverId());
    ...
    private void deliveryJobApi() {
        ...
        if (cd.isNetWorkAvailable()) {
            RetrofitService.getDeliveryJobData(null, retrofitApiClient.deliveryJobData(strId, strLatitude, strLongitude), new WebResponse() {
                @Override
